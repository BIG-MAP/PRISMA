...
class PipelineMenu:
        ...
        icons = {'baseline':'./main/icon_baseline.png',
            'baseline_peakfit':'./main/icon_baseline_fit.png',
            'baseline_corr':'./main/icon_baseline_corr.png',
            'peakfit':'./main/icon_fit.png',
            'corr':'./main/icon_corr.png'}
