...
class Spectrum:    
    ...
    def __init__(self, indexes, counts, parent = None, **kwargs):
...
class SpectrumPeakfit(Spectrum):
    ...
    def __init__(self, indexes, counts, parent, profiles, **kwargs):
        Spectrum.__init__(self, indexes, counts, parent, **kwargs)
